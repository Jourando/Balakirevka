...
var Str1="Проверка даты и времени:<br>Строки, содержащие ошибку, будут выделены цветом<br>Ошибка означает, что время начала или конца мероприятия введено некорректно (наример, начало мероприятия позже, чем его завершение).";
var Str2="Проверка места проведения:<br>Строки, содержащие ошибку, будут выделены цветом.<br>Ошибка означает, что в это же время в этом месте заявлено другое мероприятие.";
